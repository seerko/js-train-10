...
function customAssign(...objects) {
  ...
  let result = "Помилка: Має бути передано принаймні два об'єкти.";
  if (objects.length > 1) {
    result = {};
    result = Object.assign(result, ...objects);
...
function customEntries(obj) {
  ...
  let result = "Помилка: Аргумент не є об'єктом.";
...
function customObjectFromEntries(entries) {
  ...
  let result = "Помилка: Вхідний аргумент має бути масивом.";
...
function extendAndFreezeObject(obj1, obj2) {
  ...
  if (typeof obj1 === "object" && typeof obj2 === "object") {
    Object.freeze(Object.assign(obj1, obj2));
...
function keysAndValues(obj) {
  ...
  if (typeof obj === "object") {
    result = [];
    result[result.length] = Object.keys(obj);
    result[result.length] = Object.values(obj);
  }
  return result;
}
...
function filterObjectsByKey(arr, key) {
  ...
  if (Array.isArray(arr)) {
    result = arr.filter((value) => value.hasOwnProperty(key));
  }
  return result;
}
...
function getObjectValuesSum(obj) {
  ...
  let result = 0;
  if (typeof obj === "object") {
    result = Object.values(obj).reduce((sum, value) => sum + value);
  }
  return result;
}
